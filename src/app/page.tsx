...
export default function Home() {
  return (
    <div className="grid p-6 gap-4 container mx-auto border-x dark:border-light backdrop-blur-md h-full bg-zinc-100/80 dark:bg-zinc-900/80">
      <IntroductionSection />
      <ClientsCarousel />
      <div className="grid grid-cols-1 sm:grid-cols-2 grid-rows-3 sm:grid-rows-2 gap-4">
        ...
        <div className="col-span-1 sm:col-span-2 row-span-2 h-[350px]">
          <ContactOpener />
        </div>
      </div>
    </div>
