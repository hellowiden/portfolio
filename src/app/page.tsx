...
export default function Home() {
  return (
    <main
      className="container mx-auto h-full p-6 gap-6 border-x border-primary-200  dark:border-secondary-700 bg-primary-50 text-primary-900 dark:bg-secondary-900 dark:text-secondary-50
    "
    >
