...
const projects = [
  {
    ...
    description:
      'A modern reimagining of sustainable furniture design, integrating eco-friendly materials and innovative branding strategies. The project emphasizes sustainability, functionality, and aesthetics, creating furniture concepts that align with contemporary environmental concerns. Future improvements may include smart material tracking and AI-driven design optimizations.',
    image: '/green-furniture.jpg',
    link: 'https://www.greenfurnitureconcept.com',
  ...
  },
  {
    ...
    link: 'https://github.com/hellowiden/ecommerce-storefront',
  ...
  },
  {
    ...
    image: '/pp.png',
    link: 'https://github.com/hellowiden/personal-portfolio',
  ...
  },
  {
    ...
    image: '/weather.png',
    link: 'https://github.com/hellowiden/weather-app',
  ...
  },
  {
    ...
    link: 'https://github.com/hellowiden/task-manager',
  ...
  },
  {
    ...
    name: 'Airam',
    description:
      'A strategic brand transformation for a leading lighting solutions provider, focusing on modern identity and market positioning. This project showcases innovative lighting designs that enhance spaces while maintaining energy efficiency. Future enhancements include smart lighting automation and data-driven consumer insights.',
    image: '/airam.png',
    link: 'https://www.airam.fi/en/',
  ...
  },
  {
    ...
    name: 'Droga5',
    description:
      'A high-impact advertising campaign strategy built for brand positioning and creative storytelling. This project integrates innovative design thinking with consumer psychology to drive engagement and brand loyalty. Future enhancements will leverage AI-driven audience insights and digital advertising automation for optimized performance.',
    image: '/droga5.png',
    link: 'https://www.droga5.com',
