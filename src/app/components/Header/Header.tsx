          ...
          <>
            {isAdmin && (
              <button
                ...
                className="grid grid-cols-[auto_1fr] items-center p-2 text-sm sm:gap-2 border rounded transition text-black bg-zinc-200 hover:bg-zinc-300 border-light dark:text-white dark:bg-zinc-700 dark:hover:bg-zinc-800 dark:border-dark"
              >
                <motion.div
