...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-2 items-center px-4 py-2 border-b border-zinc-200 dark:border-zinc-800 transition backdrop-blur-md bg-white/80 dark:bg-black/70">
      {/* Logo / Title */}
