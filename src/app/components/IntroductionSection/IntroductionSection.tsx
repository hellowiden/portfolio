...
export default function IntroductionSection() {
  ...
  return (
    <section
      id="home"
      className="relative w-full h-[500px] bg-zinc-100 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded container mx-auto bg-cover bg-center overflow-hidden flex items-end gap-2"
    >
      <video
        autoPlay
        loop
      ...
      <div className="relative z-10 w-full grid grid-cols-[1fr_auto] grid-rows-[auto_auto] gap-4 bg-white/85 dark:bg-zinc-800/85 backdrop-blur-md p-6 text-zinc-900 dark:text-white">
