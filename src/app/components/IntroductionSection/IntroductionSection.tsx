      ...
      <div className="grid gap-4 bg-slate-50 border-zinc-300 dark:border-zinc-600">
        <div className="grid gap-2 grid-cols-[min-content_1fr] items-center">
          <Image
            ...
            height={50}
          />
          <h1 className="text-lg font-medium">Marcus Widén</h1>
        </div>

        <button
          onClick={() => router.push('/about')}
          className="grid grid-cols-[auto_1fr] items-center text-sm sm:gap-2 border rounded backdrop-blur-md p-6 transition text-black bg-zinc-100 hover:bg-zinc-200 border-zinc-300 dark:text-white dark:bg-zinc-700 dark:hover:bg-zinc-800 dark:border-zinc-600"
        >
          <FiFileText />
          <span>About me</span>
        </button>
