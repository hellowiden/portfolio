...
function IntroductionSection() {
  return (
    <section className="grid gap-4 items-center w-full h-[500px] rounded-xl text-center container mx-auto overflow-hidden bg-zinc-100 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700">
