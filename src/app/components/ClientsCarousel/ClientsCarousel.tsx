...
export default function ClientsCarousel() {
  return (
    <section
      id="clients"
      className="w-full grid place-items-center py-2 text-center border border-zinc-300 dark:border-zinc-700 backdrop-blur-md bg-white/80 dark:bg-black/70 rounded"
    >
