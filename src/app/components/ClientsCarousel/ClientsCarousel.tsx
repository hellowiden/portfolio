  ...
  return (
    ...
    >
      <Marquee
        gradient={false}
        speed={50}
        className="grid auto-flow-col auto-cols-max gap-2"
      >
        {clientsData.map(({ name, url }) => (
          <motion.a
            ...
            className="font-medium relative gap-2 group whitespace-nowrap bg-green-100 text-green-700 dark:bg-green-800 dark:text-green-200 text-sm px-2 py-1 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500"
