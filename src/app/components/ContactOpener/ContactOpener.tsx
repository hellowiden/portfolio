...
export default function ContactOpener() {
  ...
  return (
    <section
      className="bg-zinc-50/75 dark:bg-zinc-800/75 backdrop-blur-sm border dark:border-light rounded-xl bg-cover bg-center overflow-hidden relative grid h-[300px] md:h-[300px] lg:h-[300px] place-items-center p-6 text-center"
    ...
    >
      ...
      <div className="absolute inset-0 bg-zinc-50/75 dark:bg-zinc-800/75 backdrop-blur-sm flex flex-col items-center justify-center text-zinc-900 dark:text-white p-6 gap-4">
        <h1
          className={`font-bold text-4xl md:text-5xl lg:text-6xl text-white ${
            isHovered ? 'text-xl md:text-2xl lg:text-3xl' : ''
          } transition-all`}
        >
          Get in Touch
        </h1>
