...
export default function ContactOpener() {
  ...
  return (
    <section
      className="relative bg-zinc-50/75 dark:bg-zinc-800/75 backdrop-blur-sm border dark:border-light rounded-xl bg-cover bg-center overflow-hidden grid h-[300px] md:h-[300px] lg:h-[300px] place-items-center"
          ...
          <>
            <div className="grid grid-cols-[1fr_auto] items-start w-full max-w-[900px]">
              ...
              <button
                ...
                className="flex items-center gap-2 p-2 text-sm border rounded transition backdrop-blur-md bg-white dark:bg-black text-black dark:text-white hover:bg-zinc-800 hover:text-white dark:hover:bg-zinc-600 dark:border-zinc-600"
              >
                <motion.div
