...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-zinc-300 dark:border-zinc-700 backdrop-blur-md bg-zinc-50/70 dark:bg-zinc-800/70 text-zinc-900 dark:text-zinc-50 transition">
