...
export default function NotFound() {
  return (
    <div className="grid place-items-center container mx-auto bg-zinc-100 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded min-h-full p-6">
