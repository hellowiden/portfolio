      ...
      <section className="grid place-items-center p-6 bg-primary-100 dark:bg-secondary-800">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="text-sm bg-primary-900 hover:bg-primary-700 text-primary-50 p-2 rounded transition-colors disabled:opacity-50 focus:outline-none focus:ring-0 dark:bg-secondary-700 dark:hover:bg-secondary-800 dark:text-secondary-50"
          >
